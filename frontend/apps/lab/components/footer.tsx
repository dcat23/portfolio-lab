...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/dcat23", handle: "@dcat23", icon: Github },
  { label: "Twitter", href: "https://twitter.com/devincatuns", handle: "@devincatuns", icon: Twitter },
  { label: "LinkedIn", href: "https://linkedin.com/in/devin-catuns", handle: "/in/devincatuns", icon: Linkedin },
  { label: "Email", href: "mailto:devin@catuns.xyz", handle: "devin@catuns.xyz", icon: Mail },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <div className="pt-2">
              <a
                href="mailto:hello@devincatuns.dev"
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} DCAT — All experiments reserved
          </p>
        </div>
      </div>
    </footer>
